...
class MainWindow(QMainWindow):
    ...
    def setup_ui(self):
        ...
        # Painel lateral esquerdo (monitor do sistema)
        ...
        # Aba de Modelos
        self.models_widget = ModelsWidget(self.config, self.ai_engine)
    ...
    def setup_menu(self):
        ...
        refresh_models_action.triggered.connect(self.models_widget.refresh_models)
    ...
    def setup_toolbar(self):
        ...
        refresh_btn.clicked.connect(self.models_widget.refresh_models)
    ...
    def update_system_info(self):
        ...
        try:
            # Atualizar monitor do sistema (com verificação)
            ...
            try:
                ...
                self.connection_label.setText("Motor IA: Erro")
            ...
            try:
                ...
                self.models_count_label.setText("0 modelos")
                
        except Exception as e:
            # Silenciar erros repetitivos
            pass
    ...
    def show_about(self):
        ...
        QMessageBox.about(self, "Sobre SevenX Studio", 
                         ...
                         <ul>
                         <li>Gerenciamento de modelos de IA</li>
                         <li>Chat interativo com modelos locais</li>
                         <li>Monitor de sistema em tempo real</li>
    ...
    def closeEvent(self, event):
        ...
        # Limpar recursos do motor de IA
